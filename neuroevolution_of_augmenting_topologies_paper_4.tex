...
Beginning with Stanley \& Miikkulainens' first three papers about NEAT in 2002 and 2004 [cite all three] did they include thorough performance analysis, which in each case shows NEAT significantly outperforming [cite test sections from each paper] preceding NE methods. NEAT surpass these preceding methods in terms of speed, required evaluations and simplicity of the solution in key benchmarks like the double pole balancing task [cite paper establishing this benchmark], and [xor?]... [cite paper establishing this benchmark]. [possibly refer here to the comparison table]
