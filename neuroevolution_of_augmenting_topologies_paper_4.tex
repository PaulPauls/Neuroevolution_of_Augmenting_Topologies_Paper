...
% First: Stanleys favored NEAT application to determine quork size
% Then Tu-Darmstadt TCP-NEAT
% Then NEAT-Python, my application and the plan to standardize it as a TF addon

% NEAT Software catalogue: http://eplex.cs.ucf.edu/neat_software/
...
% Write about HyperNEAT, ES-HyperNEAT, Novelty Search, CoDeepNEAT, Real's research
% Write about SGD and evolution combiningn increasingly with NE for the rough evolution and backpropagation for the finetuning
