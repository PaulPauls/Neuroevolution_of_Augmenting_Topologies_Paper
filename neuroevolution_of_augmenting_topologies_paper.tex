...
% Begin with quote
% Then introduce a first description of what Neuroevolution is. Then go over to the overview and motivation
...
% further Drawbacks of classical ML Training, also serving as motivation
...
% Differentiate Neuroevolution roughly from traditional methods. Later clearly from traditional methods
% Specify area of applicability
...
% Classification of Neuroevolution Algorithms (Put examples to each classification: NEAT, HyperNEAT, CoDeepNEAT, AutoML)
...
\section{Evolutionary and Genetic Algorithms}

% Overview and Intro to Genetic Algorithms
A genetic algorithm is a search heuristic that is inspired by the theory of natural evolution. This algorithm reflects the process of natural selection where the fittest individuals are selected for reproduction in order to produce even fitter offspring of the next generation. This process keeps on iterating and at the end, a generation with the fittest individuals will be found.
...
% INITIALIZATION / INIITAL POPULATION
...
% Genetic Operators [POSSIBLY DIFFERENTIATE THESE SUB CAHPTERS INTO CROSSOVER AND MUTAITONS]
...
% Genotypes and Direct/Indirect Encoding
...
% NEATs handling of competing conventions
...
% MINMAL STRUCTURE / COMPLEXIFICATION
